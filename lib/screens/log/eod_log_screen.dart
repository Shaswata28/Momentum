              ...
              children: [
                Expanded(
                  child: _BudgetChoiceButton(
                    ...
                    activeBg: AppColors.successDone.withValues(alpha: 0.08),
                    activeFg: AppColors.successDone,
                ...
                Expanded(
                  child: _BudgetChoiceButton(
                    ...
                    activeBg: AppColors.warningTag.withValues(alpha: 0.08),
                    activeFg: AppColors.warningTag,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? activeBg : AppColors.elevatedSurface,
          borderRadius: BorderRadius.circular(10),
          border: Border.all(
            color: active ? activeFg : AppColors.dividerBorderHover,
          ),
        ),
